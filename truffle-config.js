...
module.exports = {
    ...
    networks: {
        ...
        // },
        kovan: {
            provider: () => new HDWalletProvider(mnemonic, `https://kovan.infura.io/v3/YOUR-ID`),
        ...
        rinkeby: {
            provider: () => new HDWalletProvider(mnemonic, `https://speedy-nodes-nyc.moralis.io/5c7cdebe3a912348fa5f9f4d/eth/rinkeby`),
