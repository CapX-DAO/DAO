...
// the proposal will not pass because the quorum is set to 60% while the voting power of voter2 and voter3 together is 50%
  ...
  describe("minimum quorum", async () => {
    ...
    describe("checks the overall integration for testing", async () => {
      ...
      it("checks if able to deploy Executor with given values", async () => {
        ...
        voteDuration = 5;
        voteDifferential = 0;
        // setting to 6000 so that the proposal wont pass
        minimumQuorum = 6000;
